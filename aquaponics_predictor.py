...
# Initialize label encoders and scaler (Ensure they match the ones used during training)
label_encoder_fish = LabelEncoder()
label_encoder_plant = LabelEncoder()
...
if st.button("Predict"):
    try:
        ...
        # Combine all features (in the same order as during training)
